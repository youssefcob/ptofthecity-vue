    ...
    <div class="image">
        ...
        <div class="info-wrapper">
            <div class="visibleinfo">
                <h3 class="number" @click="copy(number)">  <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                ...
                <h3 @click="copy(email)"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="26" viewBox="0 0 25 26" fill="none">
<path d="M6.94444 20.9894C5.83333 20.9894 4.72222 20.0171 4.16667 19.6005C1.38889 17.656 0.555556 16.9616 0 16.5449V22.3783C0 23.1452 0.621962 23.7671 1.38889 23.7671H12.5C13.2669 23.7671 13.8889 23.1452 13.8889 22.3783V16.5449C13.3333 16.9616 12.5 17.656 9.72222 19.6005C9.16667 20.0171 8.05556 20.9894 6.94444 20.9894ZM12.5 12.656H1.38889C0.621962 12.656 0 13.278 0 14.0449V14.7394C1.11111 15.5727 0.972222 15.5727 5 18.4894C5.41667 18.7671 6.25 19.6005 6.94444 19.6005C7.63889 19.6005 8.47222 18.7671 8.88889 18.6283C12.9167 15.7116 12.7778 15.7116 13.8889 14.8783V14.0449C13.8889 13.278 13.2669 12.656 12.5 12.656ZM23.6111 8.48937H9.72222C8.95529 8.48937 8.33333 9.11133 8.33333 9.87825V11.2671H12.5C13.9414 11.2671 15.1298 12.3704 15.2652 13.7767L15.2778 13.7671V19.6005H23.6111C24.378 19.6005 25 18.9785 25 18.2116V9.87825C25 9.11133 24.378 8.48937 23.6111 8.48937ZM22.2222 14.0449H19.4444V11.2671H22.2222V14.0449ZM6.94444 9.87825C6.94444 8.34657 8.19054 7.10048 9.72222 7.10048H19.4444V2.93381C19.4444 2.16688 18.8225 1.54492 18.0556 1.54492H4.16667C3.39974 1.54492 2.77778 2.16688 2.77778 2.93381V11.2671H6.94444V9.87825Z" fill="white"/>
</svg>
{{ email }}</h3>
            </div>

            <div class="invisibleinfo">
                <h1>We Are Always Available</h1>
                <h2>Mon-Fri: From 7am to 8pm</h2>
                <h2>Mon-Fri: From 7am to 8pm</h2>
