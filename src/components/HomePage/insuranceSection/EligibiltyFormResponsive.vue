...
<template>
    <div class="resposive-form-container">
        <span class="text-s">Check your benefits and eligibility and our team will get back to you within 30 mintues
        </span>
        <form action="">
            ...
            <button class="btn responsive main">Submit</button>
